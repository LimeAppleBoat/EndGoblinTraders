...
public class GoblinTraderSpawner
{
    ...
    private final EntityType<? extends EndGoblinTraderEntity> entityType;
    ...
    public GoblinTraderSpawner(MinecraftServer server, String key, EntityType<? extends EndGoblinTraderEntity> entityType, EndGoblinTraderEntity entity) {
