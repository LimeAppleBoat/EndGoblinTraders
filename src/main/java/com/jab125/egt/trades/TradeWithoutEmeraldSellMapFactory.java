...
public class TradeWithoutEmeraldSellMapFactory implements TradeOffers.Factory {
    ...
    public TradeWithoutEmeraldSellMapFactory(Item item, int price, TagKey<Structure> feature, String nameKey, MapIcon.Type iconType, int maxUses, int experience) {
    ...
    public TradeWithoutEmeraldSellMapFactory(Item item, int price, Item item2, int price2, TagKey<Structure> feature, String nameKey, MapIcon.Type iconType, int maxUses, int experience) {
        this.firstBuy = new ItemStack(item);
        this.price = price;
